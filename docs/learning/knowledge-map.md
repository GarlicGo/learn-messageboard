...
| Bean | 基本理解 | 被 Spring 管理的对象；默认作用域是单例。 |
| Bean 作用域 / 单例 Bean | 初步理解 | Controller、Service、Advice 等默认通常是单例 Bean；Entity、Param、VO 通常不是 Bean。 |
...
| MyBatis 代码生成 | 基本理解 | 已看过 MyBatis X 生成 Entity、Mapper、Service 和 XML 的流程。 |
